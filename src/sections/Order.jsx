    ...
    <>
      ...
      >
        <div className="bg-[rgba(96,55,9,0.51)] h-full  relative w-full flex justify-between items-center">
          {/* Content */}
          <div className="md:w-1/2 w-full  h-full flex justify-center items-start pl-10 md:pl-20 flex-col text-white font-commonFont">
            ...
            <button className="h-[40px] w-[100px] z-50 rounded-full text-[15px] mt-6 bg-yeloshColor text-cofeeColor">
              Order Now
            </button>
          </div>
